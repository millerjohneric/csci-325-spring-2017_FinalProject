...
public class ChessBoard {
    ...
    public boolean Set(){
        ...
        mTiles[1][0].setPiece(new Knight(WHITE));
        mTiles[2][0].setPiece(new Bishop(WHITE));
        mTiles[3][0].setPiece(new King(WHITE));
        mTiles[4][0].setPiece(new Queen(WHITE));
        mTiles[5][0].setPiece(new Bishop(WHITE));
        mTiles[6][0].setPiece(new Knight(WHITE));
        mTiles[7][0].setPiece(new Rook(WHITE));
        // set white pawns
        for (int leftToRight = 0; leftToRight < SIDELENGTH; leftToRight++) {
        ...
        // set black pawns
        for (int leftToRight = 0; leftToRight < SIDELENGTH; leftToRight++) {
            mTiles[leftToRight][6].setPiece(new Pawn(BLACK));
        }
        mTiles[0][7].setPiece(new Rook(BLACK));
        mTiles[1][7].setPiece(new Knight(BLACK));
        mTiles[2][7].setPiece(new Bishop(BLACK));
        mTiles[3][7].setPiece(new Queen(BLACK));
        mTiles[4][7].setPiece(new King(BLACK));
        mTiles[5][7].setPiece(new Bishop(BLACK));
        mTiles[6][7].setPiece(new Knight(BLACK));
